...
int ENA = 12; // MCU PWM Pin 10 to ENA on L298n Board
int IN1 = 14;  // MCU Digital Pin 9 to IN1 on L298n Board 
int IN2 = 15;  // MCU Digital Pin 8 to IN2 on L298n Board

int ENB = 13;  // MCU PWM Pin 5 to ENB on L298n Board
int IN3 = 2;  // MCU Digital pin 7 to IN3 on L298n Board
int IN4 = 3;  // MCU Digital pin 6 to IN4 on L298n Board
